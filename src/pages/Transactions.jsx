...
export default function Transactions() {
  ...
  const openModal = (t = null) => {
    if (t) { setEditingId(t.id); setForm({ title: t.title, amount: t.amount, type: t.type, categoryId: t.category_id || t.categoryId, status: t.status, date: (t.transaction_date || t.date).split('T')[0], is_recurring: t.is_recurring || false }) }
